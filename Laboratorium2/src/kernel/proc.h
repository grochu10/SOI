...
struct proc {
  ...
  int p_subprior;		/* podpriorytet procesu, SOI LAB2 */
  int counter;			/* licznik zaglodzenia procesu SOI LAB2 */
...
#define COUNTER_MAX 	7	/* maksymalna wartosc licznika */
/*wartosci podpriorytetow odpowiednio dla procesu bez podpriorytetu zwyklego procesu, procesu tla*/
#define SPRIO_OFF	0	
#define SPRIO_NORM	1
#define SPRIO_BACK	2
...
/*SOI LAB2*/
#define isemptysp(p)      ((p)->p_subprior == SPRIO_OFF)
#define isnormalsp(p)     ((p)->p_subprior == SPRIO_NORM)
#define isbackgroundsp(p) ((p)->p_subprior == SPRIO_BACK)
